      ...
      <header className="sticky top-0 z-10 bg-white/80 dark:bg-black/80 backdrop-blur-sm">
        ...
        <nav className="flex">
          <button
            ...
            className={`flex-1 p-4 font-bold text-center transition-colors ${activeTab === 'all' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-neutral-900'}`}
          >
            전체
          </button>
          <button
            onClick={() => setActiveTab('mentions')}
            className={`flex-1 p-4 font-bold text-center transition-colors ${activeTab === 'mentions' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-500 hover:bg-gray-100 dark:hover:bg-neutral-900'}`}
          >
            멘션
          </button>
        </nav>
