    ...
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="space-y-10">
        <section>
          <p className="text-gray-700 leading-relaxed">
            TUGO(이하 &quot;회사&quot;라 합니다)는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」 등 관련 법령을 준수하고 있습니다. 본 개인정보처리방침은 회사가 제공하는 서비스 이용과 관련하여 이용자의 개인정보가 어떻게 수집, 이용, 보관, 파기되는지를 설명합니다.
          </p>
        </section>
        ...
        <section id="section-1">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">필수 수집 정보</h3>
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li>소셜 로그인 정보 (카카오/네이버): 이메일, 이름(닉네임), 프로필 이미지</li>
                <li>서비스 이용 기록: 접속 로그, 이용 기록, 접속 IP 정보</li>
              </ul>
            </div>

            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">선택 수집 정보</h3>
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li>프로필 정보: 자기소개, 관심 분야</li>
                <li>결제 정보: 구독 시 결제 관련 정보 (결제 대행사를 통해 처리)</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section id="section-3">
          ...
          <div className="text-gray-700 leading-relaxed">
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>회원 관리:</strong> 회원 식별, 가입 의사 확인, 본인 확인, 부정 이용 방지
              </li>
              <li>
                <strong>서비스 제공:</strong> 콘텐츠 제공, 구독 서비스, 투표 참여, 맞춤 서비스 제공
              </li>
              <li>
                <strong>서비스 개선:</strong> 신규 서비스 개발, 통계 분석, 서비스 품질 향상
              </li>
              <li>
        ...
        <section id="section-4">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            <p>
              회사는 원칙적으로 개인정보 수집 및 이용 목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 관계 법령에 따라 보존이 필요한 경우에는 해당 기간 동안 보관합니다.
            </p>

            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">법령에 따른 보존 기간</h3>
              <ul className="list-disc list-inside space-y-1 text-sm">
        ...
        <section id="section-7">
          ...
          <div className="text-gray-700 leading-relaxed space-y-4">
            ...
            <p>
              위 권리 행사는 서비스 내 설정 메뉴 또는 고객센터를 통해 요청하실 수 있습니다.
            </p>
          </div>
        </section>
        ...
        <section id="section-8">
          ...
          <div className="text-gray-700 leading-relaxed">
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>접속 기록 보관: 개인정보 처리 시스템에 대한 접속 기록 보관 및 관리</li>
            </ul>
          </div>
        </section>
        ...
        <section id="section-10">
          ...
          <div className="text-gray-700 leading-relaxed">
            <p>
              본 개인정보처리방침은 법령, 정책 또는 보안 기술의 변경에 따라 내용이 추가, 삭제 및 수정될 수 있습니다. 변경 사항은 시행 7일 전에 서비스 내 공지사항을 통해 고지합니다.
            </p>
          </div>
        </section>
      </div>
      ...
      <div className="mt-12 pt-6 border-t border-gray-200">
        <p className="text-sm text-gray-500 text-center">
          ...
          <a href="mailto:privacy@tugo.kr" className="text-primary-600 hover:underline">
            privacy@tugo.kr
          </a>
          로 연락해 주시기 바랍니다.
        </p>
