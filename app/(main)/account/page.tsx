            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 font-semibold transition-colors ${
                activeTab === tab.id
                  ...
                  : 'border-b-2 border-transparent text-gray-500 hover:text-primary-500 hover:border-gray-300'
              }`}
            >
        ...
        <main className="flex-1">
          ...
          <div className="mt-8 p-6 rounded-xl bg-white border border-gray-200">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4">
              <button className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 transition-colors font-medium">
          ...
          <div className="mt-8 p-6 rounded-xl bg-red-50 border border-red-200">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-red-800">회원 탈퇴</h3>
