    ...
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      <div className="space-y-10">
        <section id="article-1">
          ...
          <p className="text-gray-700 leading-relaxed">
            본 약관은 TUGO(이하 &quot;회사&quot;라 합니다)가 제공하는 정치 커뮤니티 플랫폼 서비스(이하 &quot;서비스&quot;라 합니다)의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
          </p>
        </section>
        ...
        <section id="article-2">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                &quot;서비스&quot;란 회사가 제공하는 정치 관련 콘텐츠 게시, 구독, 투표, 토론 등의 온라인 플랫폼 서비스를 말합니다.
              </li>
              <li>
                &quot;이용자&quot;란 본 약관에 따라 회사가 제공하는 서비스를 이용하는 회원 및 비회원을 말합니다.
              </li>
              <li>
                &quot;회원&quot;이란 회사에 개인정보를 제공하고 회원등록을 한 자로서, 회사의 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
              </li>
              <li>
                &quot;크리에이터&quot;란 서비스 내에서 콘텐츠를 제작하여 게시하고, 구독 서비스를 제공하는 회원을 말합니다.
              </li>
              <li>
                &quot;게시물&quot;이란 이용자가 서비스를 이용하면서 게시한 글, 사진, 동영상, 투표 등 각종 정보를 말합니다.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section id="article-3">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>
                약관이 변경될 경우, 회사는 변경 내용을 시행일 7일 전부터 서비스 내 공지사항을 통해 공지합니다.
              </li>
              <li>
        ...
        <section id="article-4">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>
                회사는 다음 각 호에 해당하는 경우 회원가입을 거부하거나 사후에 회원자격을 제한할 수 있습니다.
        ...
        <section id="article-6">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>
                회사는 다음 각 호에 해당하는 게시물을 사전 통지 없이 삭제하거나 노출을 제한할 수 있습니다.
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
        ...
        <section id="article-7">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>이용자는 서비스 이용 시 건전한 토론 문화를 형성하기 위해 노력해야 합니다.</li>
        ...
        <section id="article-8">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>회사의 사전 동의 없이 자동화된 방법으로 서비스에 접근하는 행위</li>
            </ol>
          </div>
        </section>
        ...
        <section id="article-9">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                회사는 이용자가 본 약관 또는 관계 법령을 위반한 경우, 서비스 이용을 제한할 수 있습니다.
              </li>
              <li>
                이용 제한의 종류는 다음과 같습니다.
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
              ...
              <li>
                이용자는 서비스 이용제한에 대해 이의가 있는 경우, 고객센터를 통해 이의신청을 할 수 있습니다.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section id="article-10">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                회사는 천재지변, 불가항력적 사유로 인해 서비스를 제공할 수 없는 경우 책임이 면제됩니다.
              </li>
              <li>
                회사는 이용자가 게시한 게시물의 정확성, 신뢰성에 대해 책임을 지지 않습니다.
              </li>
              <li>
                회사는 이용자 간 또는 이용자와 제3자 간의 분쟁에 대해 관여하지 않으며, 이로 인한 손해에 대해 책임을 지지 않습니다.
              </li>
              <li>
                회사는 무료로 제공하는 서비스에 대해서는 손해배상 책임이 면제됩니다.
              </li>
            </ol>
          </div>
        </section>
        ...
        <section id="article-11">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3">
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                본 약관과 관련된 분쟁은 대한민국 법률에 따라 해석됩니다.
              </li>
              <li>
                서비스 이용과 관련하여 발생한 분쟁에 대해서는 회사의 본사 소재지를 관할하는 법원을 전속 관할 법원으로 합니다.
              </li>
            </ol>
          </div>
        </section>
      ...
      <div className="mt-12 pt-6 border-t border-gray-200">
        <p className="text-sm text-gray-500 text-center">
          본 약관에 대한 문의사항은{' '}
          <a href="mailto:support@tugo.kr" className="text-primary-600 hover:underline">
            support@tugo.kr
          </a>
          로 연락해 주시기 바랍니다.
        </p>
