              ...
              {showResults ? (
                ...
                <button
                  ...
                  className={`w-full px-3 py-2.5 rounded text-left transition ${
                    isSelected ? 'bg-gray-100 dark:bg-neutral-700' : 'hover:bg-gray-50 dark:hover:bg-neutral-800'
                  }`}
                  disabled={disabled}
                >
                  <div className="flex items-center gap-2.5">
                    <div
                      className={`w-4 h-4 rounded flex items-center justify-center flex-shrink-0 ${
                        isSelected ? 'bg-gray-900 dark:bg-neutral-100' : 'bg-gray-200 dark:bg-neutral-600'
                      }`}
                    >
                      {isSelected && (
                        <CheckIcon
