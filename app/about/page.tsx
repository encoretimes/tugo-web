      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
            <p>정치적 콘텐츠를 생산하고 구독하는 새로운 방식의 플랫폼입니다.</p>
            <p>
              특정 정치색에 치우치지 않고, 다양한 시각의 크리에이터들이 자신의
              목소리를 낼 수 있는 공간을 만들어갑니다.
            </p>
            <p>
              TUGO에서는 누구나 크리에이터가 될 수 있고, 관심 있는 크리에이터의
              콘텐츠를 구독할 수 있습니다.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  크리에이터가 만든 정치 콘텐츠를 구독하고, 양질의 분석과 시각을
                  접할 수 있습니다. 크리에이터는 구독료를 통해 지속 가능한
                  활동을 이어갑니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  댓글은 후원 금액에 따라 상위 노출됩니다. 더 많이 기여한 사람의
                  의견이 더 잘 보이는 명확하고 투명한 구조입니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  확인할 수 있습니다. TUGO만의 데이터로 사회의 목소리를
                  읽어보세요.
                </p>
              </div>
            </div>
